        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/teacher/profile.do" class="active">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/teacher/apply.do">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label for="usercode" class="col-sm-1 control-label">教工号</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="usercode" value="${USER_SESSION.tchId}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="username" value="${USER_SESSION.tchName}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                ...
                <br>
                <div class="form-group">
                    <label for="userfaculty" class="col-sm-1 control-label">学院</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userfaculty" value="${USER_SESSION.faculty}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userlevel" value="讲师"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="updatePw('${USER_SESSION.tchId}')">确认
                    </button>
                </div>
            </div>
        </div>
