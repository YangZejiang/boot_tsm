        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/student/profile.do" class="active">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label for="usercode" class="col-sm-1 control-label">学号</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="usercode" value="${USER_SESSION.stuId}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="username" value="${USER_SESSION.stuName}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                <br>
                <div class="form-group">
                    <label for="classid" class="col-sm-1 control-label">班级</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="classid" value="${USER_SESSION.classId}"
                               disabled="disabled"/>
                    </div>
                </div>
                <br>
                ...
                <br>
                <div class="form-group">
                    <label for="userlevel" class="col-sm-1 control-label">职务</label>
                    <div class="col-sm-3">
                        <c:choose>
                            <c:when test="${USER_SESSION.isMonitor == true}">
                                <input type="text" class="form-control" id="userlevel" value="班长"
                                       disabled="disabled"/>
                            </c:when>
                            <c:otherwise>
                                <input type="text" class="form-control" id="userlevel" value="成员"
                                       disabled="disabled"/>
                            </c:otherwise>
                        </c:choose>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="updatePw('${USER_SESSION.stuId}')">确认</button>
                </div>
            </div>
        </div>
    </div>
